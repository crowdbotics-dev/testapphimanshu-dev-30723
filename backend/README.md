...
## Project Structure
    ...
    ├── testapphimanshu_dev_30723  # Django project configurations
...
1. Clone this repo and `cd testapphimanshu_dev_30723`
...
2. Clone this repo and `cd testapphimanshu_dev_30723`
